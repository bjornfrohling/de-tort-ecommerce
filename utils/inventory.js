...
let inventory = [
  ...
  {
    categories: [kCategoryNewArrivals, kCategoryFrench, kCategoryVegan], name: 'Macarons', price: '1,50', image: '/products/Macarons.png', description: 'The macaron is traditionally held to have been introduced in France by the Italian chef of queen Catherine de Medici during the Renaissance. Since the 19th century, a typical Parisian-style macaron is presented with a ganache, buttercream or jam filling sandwiched between two such cookies, akin to a sandwich cookie.', brand: 'De Tort' , currentInventory: 2},
  {
    categories: [kCategorySale, kCategoryFrench, kCategoryVegan], name: 'Eclairs', price: '3,50', image: '/products/Eclairs.png', description: 'An éclair is a pastry made with choux dough filled with a cream and topped with a flavored icing. The dough, which is the same as that used for profiterole, is typically piped into an oblong shape with a pastry bag and baked until it is crisp and hollow inside.', currentInventory: 14 },
  { categories: [kCategorySale, kCategoryWorld, kCategoryVegan], name: 'Tiramisu', price: '3,50', image: '/products/Tiramisu.png', description: 'Tiramisu is a coffee-flavoured Italian dessert. It is made of ladyfingers dipped in coffee, layered with a whipped mixture of eggs, sugar, and mascarpone cheese, flavoured with cocoa. The recipe has been adapted into many varieties of cakes and other desserts.' , brand: 'De Tort', currentInventory: 13},
  { categories: [kCategorySale, kCategoryWorld], name: 'Sculptured fruits', price: '5,00', image: '/products/Sculpturedfruits.png', description: 'The fruit pastries are so authentic that if you scrolled past them on Instagram, you’d probably just assume they were the real thing. The lemons and limes come stippled with a natural texture, green leaves and all, while the apricot, full of fruit filling, has an incredibly organic texture.', brand: 'De Tort', currentInventory: 15 },

  { categories: [kCategorySale, kCategoryWorld], name: 'Small mouse cakes', price: '20,00', image: '/products/Smallmousecakes.png', description: 'Chocolate Mousse Cake is a chocolate lover\'s dream come true! Simple chocolate box cake is dressed up deliciously with a thick layer of chocolate mousse.', brand: 'De Tort', currentInventory: 44 },
  { categories: [kCategorySale, kCategoryWorld], name: 'Mouse cakes', price: '45,00', image: '/products/Mousecakes.png', description: 'This super moist dark chocolate mousse cake combines unsweetened natural cocoa powder and dark cocoa powder for an extra rich flavor.', brand: 'De Tort', currentInventory: 17 },
  { categories: [kCategorySale, kCategoryWorld], name: 'Marshmallows', price: '1,50', image: '/products/Marshmallows.png', description: 'Marshmallow is a type of confectionery that is typically made from sugar, water and gelatin whipped to a solid-but-soft consistency. It is used as a filling in baking or normally molded into shapes and coated with corn starch.', brand: 'De Tort', currentInventory: 28 },
  { categories: [kCategorySale, kCategoryWorld], name: 'Muffins', price: '2,50', image: '/products/Muffins.png', description: 'A muffin is an individually portioned baked product, however the term can refer to one of two distinct items: a part-raised flatbread that is baked and then cooked on a griddle, or an quickbread that is chemically leavened and then baked in a mold.', brand: 'De Tort', currentInventory: 31 },
